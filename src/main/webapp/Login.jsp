    					...
    					<div class="col-md-lg-4	">
         					   <form >
              					 <div class="form-group">
                					<input type="email" id="email" class="form-control" placeholder="Your Email" size="35"  required>
              					 </div>
              					 <div class="form-group">
             					 ...
             					 <a href="ForgetPassword.jsp">Forget Password....!</a>
              					 <br><div class="form-group">
                					<input type="button" id="loginbtn"  value="Login" class="btn btn-primary py-3 px-5">
                					<a href="Register.jsp" class="btn btn-primary py-3 px-5">Register</a>
             					 </div>
            					</form>
